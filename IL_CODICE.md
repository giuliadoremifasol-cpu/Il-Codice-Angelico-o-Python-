...
*Obiettivi*
    ...
    4. Riflettere sulla capacità del LLM di generalizzare regole di un "linguaggio impossibile" rispetto al semplice riconoscimento di pattern.
...
*Metodologia di ricerca*
    ...
    5. Estrazione dati finale: creazione di grafici di diverso tipo, tramite script Python, che riassume i risultati ottenuti.
